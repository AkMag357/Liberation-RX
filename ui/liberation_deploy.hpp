class liberation_deploy {
	...
	controls[] = {"OuterBG", "RecycleBG", "OuterBG_F", "InnerBG", "InnerBG_F", "Header", "DeployList", "DeployButton", "DeployMap", "LoadoutsCombo", "LabelDeploy", "LabelLoadout", "MapButton", "ButtonClose"};
